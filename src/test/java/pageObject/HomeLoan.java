...
public class HomeLoan extends basePage{
	...
	//Clicks on calculators
	public void clickcalculatorbtn() {
		calculatorbtn.click();
	}
	
	//Clicks on home loan EMI calculator
	public void clickhomeloanbtn() {
		homeloanEMI.click();
	}
	
	//Set values for home loan EMI calculator
	...
	//Fetches year on year table in excel
